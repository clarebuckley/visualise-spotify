            ...
            <div className="artistDetails col-lg-8">
                ...
                <div>
                    ...
                    {this.props.isFollowingArtist && (
                        <div>
                            <p>
                                You are one of {this.props.artistName}'s{' '}
                                {this.props.followers} followers!
                            </p>
                            <div
                                id="action-button"
                                onClick={() =>
                                    this.unfollowArtist(this.props.artistId)
                                }
                            >
                                {' '}
                                Unfollow :({' '}
                    ...
                    {!this.props.isFollowingArtist && (
                        <div>
                            <p>
                                {this.props.artistName} have{' '}
                                {this.props.followers} followers. Follow now?
                            </p>
                            <div
                                id="action-button"
                                onClick={() =>
                                    this.followArtist(this.props.artistId)
                                }
                            >
                                {' '}
                                Follow{' '}
                ...
                <Tabs
                    defaultActiveKey="popularity"
                    id="arist-details-tabs"
                    className="aristDetailsTabs"
                >
                    <Tab
                        eventKey="similarArtists"
                        title="Similar Artists"
                        className="artistTabContent"
                    >
                        <TopArtistSimilarArtists
                            ...
                            getTimeRangeInString={
                                this.props.getTimeRangeInString
                            }
                    ...
                    >
                        <TopArtistPopularity
                            ...
                            handleListClickEvent={
                                this.props.handleListClickEvent
                            }
                        />
                    </Tab>
                    <Tab
                    ...
                    >
                        {this.props.genres.map((genre, index) => (
                            <li key={index} className="artistGenre">
                                {genre}
                            </li>
                        ))}
                    </Tab>
                ...
                <audio
                    ref="song"
                    id={'artist-top-song-preview' + this.state.selectedArtist}
                >
