...
class TopArtists extends Component {
                    ...
                    this.setState(
                        ...
                        () => {
                            ...
                            this.getSimilarArtists(
                                similarArtistsReturnLimit,
                                this.state.topArtists[0].id
                            );
                        }
                    );
                })
    ...
    createNewPlaylist = (numOfSongs) => {
        var playlistName = `Songs by my Top ${
            this.state.resultLimit
        } Artists ${this.getTimeRangeInString()}`;
        var playlistDescription = `Top ${numOfSongs} song(s) by my ${
            this.state.resultLimit
        } top artists ${this.getTimeRangeInString()} as of ${getCurrentDate()}`;
        ...
        this.props.spotifyWebApi
            ...
            .then((response) => {
                ...
                uploadPlaylistImage(
                    this.props.spotifyWebApi,
                    response.id,
                    'top-artists-playlist-cover.jpeg'
                );
    ...
    handleListClickEvent = (index) => {
        ...
        this.getSimilarArtists(
            similarArtistsReturnLimit,
            this.state.topArtists[index].id
        );
    ...
    getSuccessDescription = () => {
        return `A playlist with songs by your top ${
            this.state.resultLimit
        } artists ${this.getTimeRangeInString()} has been created! Check your Spotify!`;
    };
        ...
        if (!this.state.dataHasLoaded) {
            ...
            return (
                <div className="TopArtists">
                    <SuccessModal
                        descriptionText={this.getSuccessDescription()}
                    />
                    ...
                    <div className="mainContent row justify-content-around margin-top ">
                        ...
                        <TopArtistDetails
                            ...
                            artistImage={
                                this.state.topArtists[this.state.selectedArtist]
                                    .images[0].url
                            }
                            artistName={
                                this.state.topArtists[this.state.selectedArtist]
